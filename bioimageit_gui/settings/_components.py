...
class BiAboutComponent(BiComponent):
    def __init__(self):
        ...
        label.setText('<span><p>BioImageIT v0.2.0</p></span><p>BioImageIT is an open source software funded by France-BioImaging : <a href="https://bioimageit.github.io">https://bioimageit.github.io</a></p>')
